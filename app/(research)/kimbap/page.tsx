...
export default function KimbapPage () {
  ...
  return (
    <div className="max-w-[760px] w-full min-h-screen relative z-[1] flex-col flex mx-auto my-0 p-16">
      ...
      {kimbaps?.length ? (
        kimbaps.map((kimbap) => (
          <article key={kimbap._id} className="mt-16 w-full transition-all duration-[235ms] ease-[ease] delay-[0s] shadow-[15px_28px_25px_-18px_rgba(0,0,0,0.2)] transition-all duration-[235ms] ease-[ease-in-out] delay-[0s] text-[#41403e] bg-white self-center bg-none cursor-pointer inline-block text-base p-3 rounded-tl-[255px_15px] rounded-tr-[15px_225px] rounded-br-[225px_15px] rounded-bl-[15px_255px] border-[#41403e] border-solid border-2">
